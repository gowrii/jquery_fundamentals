...
$(document).ready(function(){
	$('span').eq(1).css('background-color', 'green')
})
...
$(document).ready(function(){
	$('#target').animate('#target').width(300).height(200)
});
...
$(document).ready(function(){
	$('div').not('div:contains("span")').remove()
});
